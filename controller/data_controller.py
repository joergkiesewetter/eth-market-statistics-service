...
def get_realized_market_cap(symbol):
    ...
    symbol_file = current_app.config['MARKET_PATH_REALIZED_MARKET_CAP'] + symbol
...
def get_token_holder_stats(symbol):
    ...
    date_string = date.strftime('%Y-%m-%d')
    symbol_file = current_app.config['MARKET_PATH_TOKEN_HOLDER_STATS'] + symbol
...
def get_top_token_holder(symbol):
    ...
    date_string = date.strftime('%Y-%m-%d')
    symbol_file = current_app.config['MARKET_PATH_TOP_TOKEN_HOLDER'] + symbol + '/' + date_string
...
def get_top_token_holder_normalized(symbol):
    ...
    date_string = date.strftime('%Y-%m-%d')
    symbol_file = current_app.config['MARKET_PATH_TOP_TOKEN_HOLDER_NORMALIZED'] + symbol + '/' + date_string
